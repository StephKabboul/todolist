    ...
    <div className="mb-6 w-full min-w-0">
      <div className="flex w-full min-w-0 items-stretch gap-2">
        ...
        <select
          name="status"
          value={filters.status}
          className="min-w-0 flex-1 rounded-lg border border-gray-300 bg-gray-200 px-3 py-2 outline-none focus:border-blue-500"
          onChange={(e) =>
            setFilters({
              ...filters,
              status: e.target.value,
        ...
        <select
          value={`${sort.field}-${sort.direction}`}
          className="min-w-0 flex-[1.3] rounded-lg border border-gray-300 bg-gray-200 px-3 py-2 outline-none focus:border-blue-500"
          onChange={(e) => {
            const [field, direction] = e.target.value.split("-");
        ...
        <button
          type="button"
          onClick={handleReset}
          className="min-w-0 flex-[0.5] rounded-lg border border-gray-300 bg-gray-200 px-3 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-300 focus:border-blue-500"
        >
          Clear
        </button>
      </div>
